...
<head>
    ...
    <style>
   	...
   	<meta name ="displayInfoId" content = "<%= request.getAttribute("displayInfoId") %>">
</head>
...
<body>
        ...
        <div class="ct main">
            <div>
                <div class="section_visual">
                    ...
                    <div class="pagination">
                        ...
                        <div class="figure_pagination">
                            <span class="num"><span id="nowIndex">nowIndex</span></span>
                            <span class="num off">/ <span id="totalIndex">totalIndex</span></span>
                        </div>
                    </div>
                    <div class="group_visual">
                        <div>
                            <div class="container_visual" style="width: 414px; transform: ; transition-duration : 0.5s;">
                                <ul class="visual_img">
                                </ul>
                            </div>
							 	<div class="prev">	
                ...
                <div class="section_store_details">
                    ...
                    <a class="bk_more _open" style="display: block;"> <span class="bk_more_txt">펼쳐보기</span> <i class="fn fn-down2"></i> </a>
                    ...
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <strong class="text_value"> <span id="averageScore">averageScore</span> <em class="total">5.0</em> </strong>
                                <span class="join_count"><em class="green">commentCount건</em> 등록</span>
                            </div>
    ...
    <!-- 템플릿 모음 -->
    	...
    	<script type ="handlebarTemplate" id = "section_info_tab">
		...
		<script type = "handlebarTemplate" id = "list_short_review_item">
			 <li class="list_item">
		        <div>
		...
		<script type="handlebarTemplate" id = "list_short_review_item_no_img">
			<li class="list_item">
              <div>
