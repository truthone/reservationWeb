            ...
            <div >
              <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="/reservation/login" method="post">
                  ...
                  <div class="login_form"> 
                    ...
                    <input type="text" class="login_input ng-pristine ng-untouched ng-valid ng-empty" id="reservationEmail" name="reservationEmail" aria-invalid="false" placeholder="crong@naver.com" title="예매자이메일">
                  </div>
