...
<body>
    <div id="container">
        ...
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    <a href="../<%= request.getAttribute("displayInfoId") %>" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                            ...
                            <form:form  modelAttribute="reservationInfo" class="form_horizontal" action = "../../api/reservations" method = "post" id = "reserveInfoForm" >
                                ...
                                <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary">필수</span> <span>연락처</span> </label>
                                    <div class="inline_control tel_wrap">
                                        ...
                                        <div class="warning_msg" id="warning_msg_tel">형식이 틀렸거나 너무 짧아요</div>
                                    </div>
                                </div>
                                <div class="inline_form"> <label class="label" for="email">  <span class="spr_book ico_nessasary">필수</span>  <span>이메일</span> </label>
                                    <div class="inline_control email_wrap"> 
                                    	<input type="email" name="reservationEmail" id="email" class="email" value="" placeholder="crong@codesquad.kr" maxlength="50"> 
                              			 <div class="warning_msg" id = "warning_msg_email">형식이 틀렸거나 너무 짧아요</div>    
                                    </div>
                                </div>
                ...
                <div class="box_bk_btn">
                    ...
                    <div class="bk_btn_wrap disable"><button type = "submit" class="bk_btn" form = "reserveInfoForm"> <i class="spr_book ico_naver_s"></i>  <span>예약하기</span> </button> </div>
                </div>
            </div>
        </div>
    </div>
...
<!-- 템플릿 모음 -->
<script type="handlebarTemplate" id = "section_store_details">
...
<!-- 스크립트 모음 -->
<script src= "../../js/reserve.js?ver=1"></script>	
</html>
