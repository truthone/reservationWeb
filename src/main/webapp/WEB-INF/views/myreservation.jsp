...
<body>
	<div id="container">
		<div class="header">
			<header class="header_tit">
				...
				<a href="/reservation/logout" class="btn_my"> <span title="내예약" class="viewReservation"><span class="reservationEmail">${sessionScope.reservationEmail}</span></span> </a>
			</header>
		</div>
		<hr>
		<div class="ct">
	...
	<div class="popup_booking_wrapper" style="display:none;">
		...
		<div class="popup_booking refund">
			<h1 class="pop_tit">
				<span id="popTitle">서비스명/상품명</span>
			 	<small class="sm" id="popPeriod">2000.0.00.(월)2000.0.00.(일)</small>
			</h1>
			<div class="nomember_alert">
				<p>취소하시겠습니까?</p>
			</div>
			<div class="pop_bottom_btnarea">
				<div class="btn_gray" id="cancel_pop_noBtn">
					<a href="#" class="btn_bottom" ><span>아니오</span></a>
				</div>
				<div class="btn_green" id="cancel_pop_yesBtn">
	...
	<!-- 템플릿 모음 -->
	<script type="handlebar-template" id= "noList">
		<div class="err"> 
			<i class="spr_book ico_info_nolist"></i>
			<h1 class="tit">리스트가 없습니다</h1>
		</div>
	</script>
	<script type= "handlebar-template" id = "cardTemplate">
    	...
    	<a href="#" class="link_booking_details">
        	<div class="card_body">
                ...
                <div class="card_detail">
                    <em class="booking_number">No.</em><em class="booking_number" id="bookingNumber">{{reservationInfo.reservationInfoId}}</em>
                    <h4 class="tit">{{productInfo.productDescription}}</h4>
                    <ul class="detail">
                        <li class="item">
                            <span class="item_tit">일정</span>
                            <em class="item_dsc" id="period">
                                {{productInfo.openingHours}}
                            </em>
                        </li>
                        <li class="item">
                            ...
                            <em class="item_dsc">
                                {{#each reservationInfoPrice}}
                                    {{priceTypeName}} - ({{count}})
                                {{/each}}<br>
								: 합계 - ({{#countTotal reservationInfoPrice}}{{/countTotal}})
                            </em>
                        </li>
                        <li class="item">
                            <span class="item_tit">장소</span>
                            <em class="item_dsc">
                                    <span>{{productInfo.placeLot}}</span><br>
                                    <span>{{productInfo.placeName}}</span>
                            </em>
                        </li>
                        <li class="item">
                    ...
                    <div class="price_summary">
                        ...
                        <em class="price_amount">
                            <span>{{#caculateTotalPrice reservationInfoPrice}}{{/caculateTotalPrice}}</span>
	...
	<script type= "handlebar-template" id= "canceledCardTemplate">
		<article class="card_item">
   		 <a href="#" class="link_booking_details">
       	 <div class="card_body">
            <div class="left"></div>
            <div class="middle">
                <div class="card_detail">
                    <em class="booking_number">No.{{reservationInfo.reservationInfoId}}</em>
                    <h4 class="tit">{{productInfo.productDescription}}</h4>
                    <ul class="detail">
                        <li class="item">
                            <span class="item_tit">일정</span>
	...
	<script type= "handlebar-template" id= "usedCardTemplate">
		<article class="card_item">
   		 <a href="#" class="link_booking_details">
       	 <div class="card_body">
            <div class="left"></div>
                ...
                <div class="card_detail">
                    ...
                    <div class="price_summary">
			 		...
			 		<div class="review_write">
						<a href="/reservation/reviewWrite/{{reservationInfo.reservationInfoId}}"><button class="btn"><span>예매자 리뷰 남기기</span></button></a>
					</div>
                </div>
            </div>
            <div class="right"></div>
