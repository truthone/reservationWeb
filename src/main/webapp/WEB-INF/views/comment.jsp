...
<head>
  ...
  <meta name ="reservationInfoId" content = ${reservationInfoId}>
  ...
  <div id="container">
    <div class="header fade">
      <header class="header_tit">
        <h1 class="logo">
          <a href="/reservation/mainpage" class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo">네이버</span> </a>
    ...
    <div class="ct">
      <div class="ct_wrap">
        ...
        <div class="write_act">
          ...
          <div class="review_rating rating_point">
            <div class="rating">
              ...
              <span class="star_rank gray_star" id="score">0</span>
            </div>
          </div>
        </div>
        <!-- //리뷰 별점 -->
        ...
        <!-- 리뷰 입력 -->
        <form:form name ="reviewForm" id ="reviewForm" method = "post" action = "" enctype="multipart/form-data">
        <div class="review_contents write">
          ...
          <textarea cols="30" rows="10" class="review_textarea" maxlength ="400" minlength = "5" required></textarea>
        </div>
        <!-- //리뷰 입력 -->
        ...
        <div class="review_write_footer_wrap">
          <div class="review_write_footer">
            ...
            <input type="file" class="hidden_input" name="reviewImg" id="reviewImageFileOpenInput" accept="image/png, image/jpeg, image/jpg">
