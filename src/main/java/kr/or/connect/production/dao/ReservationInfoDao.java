...
public class ReservationInfoDao {
  ...
  private RowMapper<ReservationInfo> rowMapper = BeanPropertyRowMapper.newInstance(
  ...
  public int updateReservationCancleFlag(Integer reservationId) {
    Map<String, ?> params = Collections.singletonMap(
      "reservationId",
      reservationId
    );
  ...
  public List<ReservationInfo> selectMyReservationByEmail(
