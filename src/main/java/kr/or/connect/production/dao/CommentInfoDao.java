...
public class CommentInfoDao {
  ...
  private RowMapper<CommentInfo> rowMapper = BeanPropertyRowMapper.newInstance(
    CommentInfo.class
  );
  ...
  public int countCommentInfo(Long displayInfoId) {
    ...
    if (
      jdbc.queryForObject(COUNT_COMMENT_INFO, params, Integer.class) != null
    ) {
      countcommentInfo =
        jdbc.queryForObject(COUNT_COMMENT_INFO, params, Integer.class);
    }
  ...
  public double getcommenTotalScore(Long displayInfoId) {
    ...
    if (
      jdbc.queryForObject(TOTAL_SCORE_OF_COMMENT, params, Integer.class) != null
    ) {
      commentTotlaScore =
        jdbc.queryForObject(TOTAL_SCORE_OF_COMMENT, params, Integer.class);
    }
