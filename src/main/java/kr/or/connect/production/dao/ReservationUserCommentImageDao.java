...
public class ReservationUserCommentImageDao {
  ...
  private RowMapper<ReservationUserCommentImageDao> rowMapper = BeanPropertyRowMapper.newInstance(
    ReservationUserCommentImageDao.class
  );
  ...
  public Long insertReservationUserCommentImage(
