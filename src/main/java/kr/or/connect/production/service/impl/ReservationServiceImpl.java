...
public class ReservationServiceImpl implements ReservationService {
  ...
  @Override
  @Transactional(readOnly = false)
  public ReservationInfoPrice addReservationInfoPrice(
    ReservationInfoPrice reservationInfoPrice
  ) {
    Long reservationInfoPriceId = reservationInfoPriceDao.insertReservationInfoPrice(
  ...
  public List<ReservationInfo> getMyReservationInfo(String reservationEmail) {
    List<ReservationInfo> list = reservationInfoDao.selectMyReservationByEmail(
      reservationEmail
    );
    return list;
  }
  ...
  public List<ReservationInfo> getReservationInfo(Long reservationId) {
    List<ReservationInfo> list = reservationInfoDao.selectReservationById(
      reservationId
    );
    return list;
  }
  ...
  @Override
  public List<MyReservationPriceInfoAndCount> getMyReservationPriceInfo(
    Long reservationId
  ) {
    List<MyReservationPriceInfoAndCount> list = reservationInfoPriceDao.selectMyReservationPrice(
      reservationId
    );
    return list;
  }
  ...
  public Integer cancelReservation(Integer reservationId) {
    Integer updateCount = reservationInfoDao.updateReservationCancleFlag(
      reservationId
    );
    return updateCount;
  }
