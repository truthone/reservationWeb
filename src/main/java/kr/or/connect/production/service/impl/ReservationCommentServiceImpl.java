...
public class ReservationCommentServiceImpl implements ReservationCommentService{
	...
	public Long addReservationComment(ReservationUserComment reservationUserComment) {
		reservationUserComment.setCreateDate(new Date());
		reservationUserComment.setModifyDate(new Date());
		Long reservationUserCommentId = reservationUserCommentDao.insertReservationUserComment(reservationUserComment);
		return reservationUserCommentId;
	}

	@Override
	@Transactional(readOnly = false)
	public Long addReservationCommentImageInfo(ReservationUserCommentImage reservationUserCommentImage) {
		Long reservationUserCommentImageId = reservationUserCommentImageDao.insertReservationUserCommentImage(reservationUserCommentImage);
